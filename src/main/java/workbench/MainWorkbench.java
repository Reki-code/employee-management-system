...
import main.java.workbench.moudle.*;
...
public class MainWorkbench {
    ...
    public Workbench buildWorkbench() {
        workbench = Workbench.builder(
                ...
                .build();
        workbench.getStylesheets().add(getClass().getResource("/main/resources/styles/main.css").toExternalForm());
        return workbench;
    }
    ...
    private WorkbenchDialog profileDetail() {
        Node profile = null;
        try {
            profile = FXMLLoader.load(getClass().getResource("/main/resources/fxml/Profile.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
